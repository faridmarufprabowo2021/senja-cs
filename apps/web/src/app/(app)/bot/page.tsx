            ...
            <Card className="p-5">
              ...
              {activeTab === "followups" ? (
                <div className="space-y-4">
                  ...
                  <div className="pt-3 border-t border-[var(--color-line)] space-y-3">
                    <div className="flex items-center justify-between p-3.5 border rounded-xl border-[var(--color-line)] bg-[var(--color-surface)]">
                      <div>
                        <div className="font-semibold text-xs text-[var(--color-ink)] flex items-center gap-1.5">
                        ...
                        <div className="text-[11px] text-[var(--color-muted)] mt-0.5">
                          Mencegah AI mengirim pesan follow-up di malam hari agar nomor WA tidak dilaporkan spam oleh pelanggan.
                        </div>
                      </div>
                      <input
                        type="checkbox"
                    ...
                    {editForm.quietHoursEnabled ?? true ? (
                      <div className="grid gap-3 sm:grid-cols-3 bg-[var(--color-paper-2)]/50 p-3 rounded-xl border border-[var(--color-line)]">
                        <div>
                          <label className="mb-1 block text-xs font-semibold text-[var(--color-ink)]">
                            Jam Mulai (DND)
                          </label>
